...
## Environments
- Preview: https://main--eds-commerce--JosephMaxwell.aem.page/
- Live: https://main--eds-commerce--JosephMaxwell.aem.live/
...
1. Open the `eds-commerce` directory in your favourite IDE and start coding :)
